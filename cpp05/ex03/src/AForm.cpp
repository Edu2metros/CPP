...
const char *AForm::GradeExecException::what(void) const throw ()
{
	return("The Bureaucrat cannot execute if the grade to execute is greater than required. Your grade is: ");
}
